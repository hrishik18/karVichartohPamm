    ...
    <div className="min-h-screen bg-page text-heading flex flex-col">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
        <a
          ...
          className="flex items-center gap-2 bg-[#EA4335] hover:bg-[#d33426] text-white pl-4 pr-5 py-3 rounded-full shadow-lg shadow-black/30 transition-colors"
          aria-label="Email us"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe57] text-white pl-4 pr-5 py-3 rounded-full shadow-lg shadow-black/30 transition-colors"
